...
const runTestsTs = path.join(__dirname, 'run_tests.ts');
const runTestsTmpJs = path.join(__dirname, 'run_tests.tmp.js');

try {
  console.log("Compiling run_tests.ts with esbuild...");
